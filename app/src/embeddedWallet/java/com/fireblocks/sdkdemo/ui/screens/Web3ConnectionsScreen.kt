...
import com.fireblocks.sdkdemo.bl.core.extensions.toFormatedDateTime
...
fun Web3ConnectionListItem(modifier: Modifier = Modifier,
    ...
    val date = web3Connection.creationDate?.let {
        val formattedDate = it.toFormatedDateTime()
        formattedDate
    } ?: "" // 2023-07-04 12:00:00

    Row(
        modifier = modifier
            .background(shape = RoundedCornerShape(size = dimensionResource(id = R.dimen.round_corners_list_item)), color = grey_1)
