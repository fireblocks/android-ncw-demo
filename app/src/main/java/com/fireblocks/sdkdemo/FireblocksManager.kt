...
class FireblocksManager : CoroutineScope {
     ...
     * Please ask your CSM or in the [fireblocks](https://community.fireblocks.com/) to enable your workspace to support EdDSA if you wish to work with EdDSA chains.
     */
